...
export default function DraBrunaLanding() {
  ...
  const whatsappUrl = "https://wa.me/5561996626541"

  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-green-50/20 to-white relative overflow-hidden">
            ...
            <div className="order-1 lg:order-1 space-y-8 relative z-10">
              <div className="space-y-6">
                <h1
                  ...
                  style={{ fontFamily: "Georgia, serif" }}
                >
                  Você já conquistou tantas coisas… mas ainda não conquistou a si mesmo?
                </h1>
                <p
                  className="text-xl lg:text-2xl text-gray-700 leading-relaxed drop-shadow-sm"
                  style={{ fontFamily: "Georgia, serif" }}
                >
                  A Terapia Integrativa ajuda você a reencontrar propósito, leveza e paz interior para viver sua melhor
                  versão.
                </p>
              </div>
      ...
      {/* Como Funciona */}
      <section id="como-funciona" className="py-16 lg:py-24 bg-gradient-to-br from-white to-green-50/30 relative">
        <div className="container mx-auto px-4 relative z-10">
      ...
      {/* Ajuda */}
      <section id="ajuda" className="py-16 lg:py-24 bg-white relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl xl:text-5xl font-bold text-[#152d28] mb-8"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="p-8 bg-gradient-to-br from-green-50/50 to-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-green-100/50 text-center"
              >
                <h3
      ...
      <section
        id="beneficios"
        className="py-16 lg:py-24 bg-gradient-to-br from-[#2a5951]/5 via-[#dc9650]/5 to-white relative"
      >
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2
      ...
      {/* Sobre */}
      <section id="sobre" className="py-16 lg:py-24 bg-white relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      {/* Depoimentos */}
      <section id="depoimentos" className="py-16 lg:py-24 bg-gradient-to-br from-[#152d28]/5 to-[#2a5951]/5 relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2
      ...
      {/* Contatos */}
      <section id="contato" className="py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-green-50/30 relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2
              className="text-3xl lg:text-4xl xl:text-5xl font-bold text-[#152d28] mb-6"
