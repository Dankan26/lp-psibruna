...
export default function DraBrunaLanding() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Button
                onClick={handleWhatsAppClick}
                className="hidden lg:flex items-center space-x-2 bg-[#2a5951] hover:bg-[#1e3a33] text-white px-6 py-3 rounded-full font-bold text-lg shadow-lg transition-all duration-300"
                style={{ fontFamily: "Georgia, serif" }}
                data-gtm-event="whatsapp_click"
          ...
          {isMenuOpen && (
            <div className="lg:hidden mt-4 pb-4 border-t border-gray-200 bg-white/95 backdrop-blur-md rounded-lg shadow-lg">
              <nav className="flex flex-col space-y-4 mt-4 px-4">
                ...
                <Button
                  onClick={handleWhatsAppClick}
                  className="flex items-center justify-center space-x-2 bg-[#2a5951] hover:bg-[#1e3a33] text-white px-6 py-3 rounded-full font-bold text-lg mt-4 shadow-lg transition-all duration-300"
                  style={{ fontFamily: "Georgia, serif" }}
                  data-gtm-event="whatsapp_click"
      ...
      <section className="pt-24 pb-16 lg:pt-32 lg:pb-24 relative overflow-hidden bg-gradient-to-br from-[#2a5951] to-[#1a4038]">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-1 lg:order-1 space-y-8 relative z-10">
              ...
              <Button
                onClick={handleWhatsAppClick}
                className="flex items-center space-x-3 bg-white hover:bg-gray-50 text-[#2a5951] px-8 py-4 rounded-full text-xl font-bold shadow-xl transform hover:scale-105 transition-all duration-300"
                style={{ fontFamily: "Georgia, serif" }}
                data-gtm-event="whatsapp_click"
                data-gtm-location="hero"
              >
                <Sprout className="w-6 h-6 text-[#2a5951]" />
                <span>Agendar agora</span>
              </Button>
            </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="space-y-6">
              <Button
                onClick={handleWhatsAppClick}
                className="flex items-center space-x-3 bg-[#dc9650] hover:bg-[#c8854a] text-white px-10 py-5 rounded-full text-xl font-bold shadow-2xl mx-auto transform hover:scale-105 transition-all duration-300"
                style={{ fontFamily: "Georgia, serif" }}
                data-gtm-event="whatsapp_click"
